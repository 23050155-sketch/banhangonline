  ...
  <div class="container">
    <div class="slider-container" id="heroSlider" data-interval="3500">
      <div class="slider">
        ...
        <div class="slide">
          <img src="https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=1600&q=80" alt="Giảm giá hot" />
          <div class="slide-content">
        ...
        <div class="slide">
          <img src="https://images.unsplash.com/photo-1526402462727-0bfa7a6b3d2b?auto=format&fit=crop&w=1600&q=80" alt="Hàng mới" />
          <div class="slide-content">
            <h3>Hàng mới về</h3>
    ...
    <div class="container">
        ...
        @if(request()->filled('brand') && isset($products))
            <div class="section-head keep-right">
                ...
                <a class="btn ghost" href="{{ route('clothes.page') }}">
                    ← Quay về tất cả
                </a>
            </div>
            ...
            @foreach($productsByBrand as $brand => $items)
                <div class="brand-section" style="margin-top:16px;">
                    <div class="section-head">
                        ...
                        <a class="btn ghost"
                           href="{{ route('clothes.page', ['brand' => $brand]) }}">
